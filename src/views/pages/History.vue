      ...
      <section class="main-container">
        ...
        <main>
          <div class="history-main">
            ...
            <p class="text-transaction">
              your transaction history after transfer to your friends
            </p>
          ...
          <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
              <li
                class="page-item"
                :class="[getPagination.prevPage == null ? 'disabled' : '']"
              >
                <a
                  class="page-link"
                  href="#"
                  @click.prevent="
                    getTransactionHistory(
                      parseInt(getPagination.currentPage) - 1
                    )
                  "
                  >Previous</a
                >
              ...
              <li
                v-for="noPage in getPagination.totalPage"
                :key="noPage"
                :class="[getPagination.currentPage == noPage ? 'active' : '']"
                class="page-item"
              >
                <a
                  class="page-link"
                  href="#"
                  @click.prevent="getTransactionHistory(noPage)"
                  >{{ noPage }}</a
                >
              </li>
              <li
                class="page-item"
                :class="[getPagination.nextPage == null ? 'disabled' : '']"
              >
                <a
                  class="page-link"
                  href="#"
