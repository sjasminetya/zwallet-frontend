          ...
          <div class="personal-main">
            ...
            <div class="content-personal">
              <div class="first-name">
                <p>First Name</p>
                <h6 v-set-font:medium v-set-font:capitalize>
                  {{ profile.firstName }}
                </h6>
              </div>
                  ...
                  <form>
                    <div class="form-group">
                      ...
                      <input
                        ...
                        :class="{
                          'is-invalid': validationStatus($v.phoneNumber),
                        }"
                        type="number"
                      ...
                      >
                        ...
                        {{ $v.phoneNumber.$params.maxLength.max }} number.
                      </div>
                    </div>
                  </form>
                </b-modal>
                <router-link
                  to="/page/manage-phone-number"
                  class="manage-number"
                  >Manage</router-link
                >
              </div>
...
export default {
  ...
  methods: {
    ...
    addNumber () {
      ...
      this.addPhoneNumber(payload).then((res) => {
