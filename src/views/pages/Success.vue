      ...
      <section class="main-container">
        ...
        <main>
          <div class="confirmation-main">
            <img
              class="success"
              src="../../assets/img-main/success.png"
              alt="Transfer Succes"
            />

            <h6 v-set-font:small class="confirmation-transfer">
              Transfer Success
            </h6>
            ...
            <div class="content-confirmation">
              ...
              <div class="name-samuel">
                ...
                <div class="text-samuel">
                  <h6 v-set-font:uppercase>
                    {{ transferToFriend.firstName }}
                    {{ transferToFriend.lastName }}
                  </h6>
              ...
              <div class="button-success">
                <div class="text-center mr-3">
                  ...
                  >
                    <img
                      src="../../assets/img-main/download-button.png"
                      alt="download button"
                    />
    ...
    download () {
      const doc = {
        content: [
          ...
          {
            text: 'Rp ' + this.changeRupiah(this.dataTransfer.amount),
            style: 'isi'
          },
          ...
          {
            text: this.transferDate(this.dataTransfer.date_time),
            style: 'isi'
          },
          ...
          {
            text:
              this.transferToFriend.firstName +
              ' ' +
              this.transferToFriend.lastName,
            style: 'isi',
            margin: [80, -50, 0, 0]
          },
          {
            text: this.transferToFriend.phoneNumber,
            style: 'isi',
            margin: [80, 0, 0, 0]
          }
        ],
        ...
        footer: {
          columns: [{ text: 'Zwallet Team', style: 'footer' }]
        },
        styles: {
          isi: {
            fontSize: 18,
